...
export default function Dashboard({ user, dark, toggleTheme }) {
  ...
  const topics = [
    ...
    { id: '2', iconType: 'music', title: 'Music & Culture', description: 'Express yourself through music and the arts', progress: 0 },
    { id: '3', iconType: 'plane', title: 'Travel & Adventure', description: 'Navigate the world with confident English', progress: 0 },
    { id: '4', iconType: 'robot', title: 'AI & Technology', description: 'Discuss the future in fluent English', progress: 0 },
  ];
